...
class Test_utils:
    ...
    def load_configuration(self,conf):
       ...
       attributes=['WMS','JDLFILE','LB','VO','MYPROXYSERVER','WMS_USERNAME','WMS_PASSWORD','YAIM_FILE','LOG_LEVEL','DEFAULTREQ','NUM_STATUS_RETRIEVALS','SLEEP_TIME','DELEGATION_OPTIONS']
