#
# Bug: 88450
# Title: Ice configuration section doesn't use environment variable
# Link: https://savannah.cern.ch/bugs/?88450
#
#
...
def run(utils):
    ...
    if(len(z)>0):
        logging.error("Problem with the following attributes in the ICE section: %s"%(z))
